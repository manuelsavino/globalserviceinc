  ...
  return (function (t) {
    ...
    0: function (t, e, i) {
      ...
      const a = t => document.querySelector(t),
        ...
        p = t => 0.299 * t.r + 0.587 * t.g + 0.114 * t.b
    },
    1: function (t, e, i) {
      "use strict"
      i.d(e, "a", function () {
    ...
    10: function (t, e, i) {
      ...
      class h extends s.b {
        ...
        onInit() {
          ...
          ;(this.linesMesh2 = new r.LineSegments(p, l)),
          ...
          for (let t = 0; t < this.points.length; t++) {
            ...
            const c = this.points[t],
              p = (n = this.rayCaster
                ...
                : 1e3).clamp(5, 15)
            ;(c.scale.z = (0.25 * (15 - p)).clamp(1, 100)),
            ...
            for (let n = t; n < this.points.length; n++) {
              const t = this.points[n],
                p = c.position.x - t.position.x,
                u = c.position.y - t.position.y,
